...
// Tanımlama Ajanı sohbet arayüzü buraya gelecek (docs/agent-specs.md § 2).
export default function TanimlamaSayfasi() {
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-6 px-6 py-16 sm:py-24">
      <h1 className="font-heading text-2xl font-semibold">Tanımlama Ajanı</h1>
      <p className="text-muted-foreground">
        İhtiyaç kartı sohbeti burada açılacak. Henüz bağlanmadı.
      </p>
